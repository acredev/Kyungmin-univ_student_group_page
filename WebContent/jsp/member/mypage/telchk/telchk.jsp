...
<html>
		...
		<script type="text/javascript">
			function telchk_result()
			{
				...
				else
				{
					...
					{
						alert("휴대폰 본인인증이 완료되었습니다. 변경사항을 저장하기 위해서는, 마이페이지 화면에서 [저장] 버튼을 눌러주셔야만 저장이 가능합니다.");
						opener.document.mypage.isTelChange.value = "yes";
						opener.document.mypage.tel.readOnly = true;
						opener.document.mypage.tel.style.color = "blue";
						opener.document.mypage.tel.style.onfocus = "this.blur()";
						opener.document.mypage.telchk.disabled = "true";
						window.close();
					}
					else
					{
	...
	<script src="/19831049_finalproject/js/mypage.js"></script>ㄴ
</body>
</html>